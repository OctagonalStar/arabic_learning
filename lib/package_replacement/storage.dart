...
// import 'package:arabic_learning/package_replacement/fake_dart_io.dart' if (dart.library.html) 'package:idb_shim/idb_browser.dart';
  ...
  Future<bool> setString(String key, String value) async {
    if (type) {
      ...
      try {
        ...
        var txn = db.transaction("data", idbModeReadWrite);
        var store = txn.objectStore("data");
