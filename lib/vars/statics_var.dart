...
## 2. 文章难度（difficulty）量化标尺

**文章难度（difficulty）** 是由文章本身的词汇难度、句法复杂度和主题抽象度决定。
...
  "questions": [
    {
      "riddle": <String类型，问题题干>,
      "answers": ["<正确答案>", "<干扰选项1>", "<干扰选项2>", "<干扰选项3>"], <List<String>类型，题目选项，最多7个选项>
      "type": <String类型，从“题型标签”枚举列表中选取>,
      "analysis": <String类型，简体中文解析，**严禁使用英文双引号"**，请改用引号「」；提及正确选项时需要完整写出其选项内容，不可写为“第一项”或“A项”>
    },
    ...
  ]
}
