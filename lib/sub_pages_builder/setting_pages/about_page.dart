    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          TextContainer(text: "该软件仅供学习使用，请勿用于商业用途。\n该软件基于GNU GENERAL PUBLIC LICENSE (Version 3)协议开源，协议原文详见页面底部。", style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.bold)),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("5. 其他在GNU GENERAL PUBLIC LICENSE (Version 3)开源协议下的条款"),
              ],
            ),
          ),
          TextContainer(text: "GNU GENERAL PUBLIC LICENSE (Version 3)开源协议 / GNU GENERAL PUBLIC LICENSE License"),
