            ...
            SettingItem(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    context.read<Global>().uiLogger.info(
                      "跳转: SettingPage => QuestionsSettingPage",
                    );
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => QuestionsSettingPage(),
                      ),
                    );
                  },
                  child: Row(
                          ...
                          child: FittedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("选择文本转语音接口"),
                                Text(
                                  "默认使用系统自带的文本转语音接口，但有些厂商可能没有阿拉伯语支持\n若使用\"神经网络合成语音\"你必须使用APP端并下载模型。",
                                  style: TextStyle(
                                    fontSize: 8.0,
                                    color: Colors.grey,
                                  ),
                    ...
                    DropdownButton(
                      ...
                      items: [
                        ...
                        DropdownMenuItem(
                          ...
                          enabled: kIsWeb
                              ? false
                              : (AppData().modelTTSDownloaded ? true : false),
                          child: Text(
                            "神经网络合成语音",
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text("自动播放发音"),
                          Text(
                            "开启后将会在<学习>模块中，每进入阿译中选择题时阅读当前单词发音。",
                            style: TextStyle(fontSize: 8.0, color: Colors.grey),
                          ),
                        ],
                      ),
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    if (kIsWeb) {
                      ...
                      context.read<Global>().uiLogger.info(
                        "跳转: SettingPage => ModelDownload",
                      );
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => ModelDownload(),
                        ),
                      );
                    }
                  },
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: mediaQuery.size.width * 0.01),
                      Expanded(child: Text("下载神经网络文本转语音模型")),
